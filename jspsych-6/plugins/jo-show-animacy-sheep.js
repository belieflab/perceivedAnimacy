...
jsPsych.plugins["jo-show-animacy-sheep"] = (function() {

  var plugin = {};

  plugin.info = {
    name: "jo-show-animacy-sheep",
    parameters: {
      trial_id: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function animate_path(){
      ...
      if (parseInt(percent_time*num_frames) >= 120){
        ...
        context.fillText("Click on the disc that looked like it was being chased by another disc", 10, 25);
