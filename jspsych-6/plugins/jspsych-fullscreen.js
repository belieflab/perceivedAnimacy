...
jsPsych.plugins.fullscreen = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    let keyboardNotAllowed = typeof Element !== 'undefined' && 'ALLOW_KEYBOARD_INPUT' in Element;
    if (keyboardNotAllowed) {
      ...
      if(trial.fullscreen_mode){
        ...
        let listener = display_element.querySelector('#jspsych-fullscreen-btn').addEventListener('click', function() {
