...
black = imread('lastFrame.jpg');

% loop for chasing
for v = 1:300 
    reader = VideoReader(['chasing\trial' ...
        num2str(v) '.mp4']);
...
for v = 1:300 
    reader = VideoReader(['mirror_chasing\trial' ...
        num2str(v) '.mp4']);
    writer = VideoWriter(['mirror_chasing2\trial' num2str(v) 'mod.mp4'], ...
        'MPEG-4');
    writer.FrameRate = reader.FrameRate;
