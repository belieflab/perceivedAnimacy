...
black = imread('lastFrame3.png');

% loop for chasing
for v = 1:300 
    reader = VideoReader(['van_Buren_stimuli\chasing_detection_stimuli\chasing\trial' ...
        num2str(v) '.mp4']);
...
for v = 1:300 
    reader = VideoReader(['van_Buren_stimuli\chasing_detection_stimuli\mirror_chasing\trial' ...
        num2str(v) '.mp4']);
