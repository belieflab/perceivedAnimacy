...
const randTestTrials = randTrials.slice(
    numberPracticeTrials,
    numberPracticeTrials + numberTestTrials
);
...
for (let i = 0; i < randPracticeTrials.length; i++) {
    chasePractice.push(
        "stim/chasing2/trial" + randPracticeTrials[i] + "mod.mp4"
    );
    noChasePractice.push(
        "stim/mirrorChasing2/trial" + randPracticeTrials[i] + "mod.mp4"
    );
}
// test trials
let chaseTest = [];
...
for (let i = 0; i < randTestTrials.length; i++) {
    ...
    noChaseTest.push(
        "stim/mirrorChasing2/trial" + randTestTrials[i] + "mod.mp4"
    );
}
